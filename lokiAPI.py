...
class LokiAPI:
    ...
    def get_swarms(self, pubkeys):
        ...
        for pubkey in pubkeys:
            self.swarm_cache[pubkey] = LokiDatabase.get_instance().get_swarms(pubkey)
            if len(self.swarm_cache[pubkey]) > 0:
                continue
    ...
    def fetch_raw_messages(self, pubkey_list):
        ...
        for pubkey in pubkey_list:
            ...
            hash_value = LokiDatabase.get_instance().get_last_hash(pubkey)
